...
import { GripVertical, Link as LinkIcon, Minus, Trash2, Type, CalendarIcon } from "lucide-react";
...
export function LinkItemCard({ id, type, title, url, isActive = true, startDate, endDate, onDelete, onUpdate }: LinkItemProps) {
